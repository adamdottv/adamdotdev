...
type DefaultStingerAnimation = StingerAnimation<{}>;
type BasicStingerAnimation = StingerAnimation<{
  duration: number;
  startTime: number;
}>;
type PhasedStingerAnimation = StingerAnimation<{
  duration: number;
  startTime: number;
  phases: number;
}>;
type ColumnStingerAnimation = StingerAnimation<{
  duration: number;
  startTime: number;
  column_values: Array<number>;
}>;

export type AnyStingerAnimation =
  | DefaultStingerAnimation
  | BasicStingerAnimation
  | PhasedStingerAnimation
  | ColumnStingerAnimation;

export const defaultAnimation: DefaultStingerAnimation = {
  initFn: () => ({}),
  stateFn: ({ x, y }) => {
    const time = Date.now();
...
export const kyllian1: BasicStingerAnimation = {
  author: "KyllianGamer",
  initFn: () => ({
    duration: 2600,
...
export const kyllian2: BasicStingerAnimation = {
  author: "KyllianGamer",
  initFn: () => ({
    duration: 2000,
...
export const kyllian3: PhasedStingerAnimation = {
  author: "KyllianGamer",
  initFn: () => ({
    duration: 2000,
    startTime: Date.now() % 2000,
...
export const kyllian4: ColumnStingerAnimation = {
  author: "KyllianGamer",
  initFn: () => ({
    duration: 2000,
    startTime: Date.now() % 2000,
...
export const matthewbrandt1: DefaultStingerAnimation = {
  initFn: () => ({}),
  stateFn: ({ x, y }) => {
...
export const schrew: BasicStingerAnimation = {
  author: "schrew",
  initFn: () => ({
    duration: 2500,
    startTime: Date.now(),
...
export const animations: AnyStingerAnimation[] = [
  defaultAnimation,
  kyllian1,
  kyllian2,
  kyllian3,
