...
function Shared({
  ...
  //         (c) =>
  //           c.deviceId ===
  //           "f808c98cb0a263097eb4b03d876b885c6f153c07c32138b722f23d0b40a22eda"
  //       ) || camlinkCameras[0]
  //
  ...
  //           const [{ expressions, landmarks }] = detectionsWithExpressions
  //           console.log(landmarks.shift)
  //           const abnormality = [
  ...
  useTwitchEvent(socket, handleTwitchEvent)
