...
export default class TwitchController {
  ...
  userId = process.env.TWITCH_USER_ID as string
  ...
  async updateStreamMetadata(data: HelixChannelUpdate) {
    return this.apiClient?.channels.updateChannelInfo(this.userId, data)
  }
}
