...
export default async function LandingPage() {
  ...
  const topic = `${Resource.App.name}/${Resource.App.stage}/notifs`;
    ...
    <main className="relative h-screen overflow-y-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 flex flex-col items-center justify-center gap-10 px-5 text-center text-mauve-12">
        ...
        <div className="pointer-events-auto flex max-w-lg items-center gap-6 text-mauve-11 [&>*]:p-1">
          <a href="/x" target="_blank" className="hover:text-mauve-12">
            <svg
              role="img"
              viewBox="0 0 24 24"
          ...
          <a href="/twitch" target="_blank" className="hover:text-mauve-12">
            <svg
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a href="/youtube" target="_blank" className="hover:text-mauve-12">
            <svg
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
